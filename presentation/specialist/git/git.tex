...
\addtobeamertemplate{note page}{\setlength{\parskip}{8pt}}
...
\title{Git}
\subtitle{Curtin FIRST Robotics Club (FRC) Specialist Training}
\date{\today}
\author{Scott Day}
...
\begin{frame}[fragile]{Insert Mandatory Programming Joke}
    \begin{center}
        \makebox[\textwidth]{\includegraphics[width=0.95\paperwidth,height=0.95\textheight]{graphics/git-pretty.png}}
    \end{center}
\end{frame}

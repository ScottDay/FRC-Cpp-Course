...
\title{Lecture 3: Flow of Control}
...
\begin{frame}[fragile]{Control Structures}
    \texttt{Control structures} are portions of program code that contain statements within them and, depending on the circumstances, execute these statements in a certain way. There are typically two kinds: \texttt{conditionals} and \texttt{loops}.
\end{frame}
...
\subfile{sections/conditionals.tex}
\subfile{sections/loops.tex}
\subfile{sections/nestedcontrolstructures.tex}
